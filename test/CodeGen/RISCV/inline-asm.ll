...
; RV32I-NEXT:    #NO_APP
; RV32I-NEXT:    ret
  tail call void asm sideeffect "add a0, a0, $0", "J"(i32 0)
  ret void
}
...
define i32 @modifier_z_zero(i32 %a) {
...
define i32 @modifier_z_nonzero(i32 %a) {
...
define i32 @modifier_i_imm(i32 %a) {
...
define i32 @modifier_i_reg(i32 %a, i32 %b) {
