...
#include "MipsGenAsmMatcher.inc"
  ...
  void expandCapLoadC1(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                       MCStreamer &Out, const MCSubtargetInfo *STI);

  void expandCapStoreC1(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                        MCStreamer &Out, const MCSubtargetInfo *STI);

  void expandCapMove(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                     MCStreamer &Out, const MCSubtargetInfo *STI);
...
MipsAsmParser::tryExpandInstruction(MCInst &Inst, SMLoc IDLoc, MCStreamer &Out,
  ...
  case Mips::CLWC1:
    is64Bit = false;
  case Mips::CLDC1:
    expandCapLoadC1(Inst, is64Bit, IDLoc, Out, STI);
    return MER_Success;
  case Mips::CSWC1:
    is64Bit = false;
  case Mips::CSDC1:
    expandCapStoreC1(Inst, is64Bit, IDLoc, Out, STI);
    return MER_Success;
  case Mips::CMove:
    expandCapMove(Inst, is64Bit, IDLoc, Out, STI);
    return MER_Success;
...
void MipsAsmParser::expandCapMove(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                                  MCStreamer &Out, const MCSubtargetInfo *STI) {
...
void MipsAsmParser::expandCapStoreC1(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                                     MCStreamer &Out, const MCSubtargetInfo *STI) {
  MCInst tmpInst;
...
void MipsAsmParser::expandCapLoadC1(MCInst &Inst, bool Is64Bit, SMLoc IDLoc,
                                    MCStreamer &Out, const MCSubtargetInfo *STI) {
  MCInst tmpInst;
  unsigned AtRegNum = getReg(
    Is64Bit ? Mips::GPR64RegClassID : Mips::GPR32RegClassID, getATReg(IDLoc));
  ...
  if (ABI.ArePtrs64bit() && isGP64bit()) {
    ...
    if (!Is32BitSym) {
      ...
      if (ATReg && !(UseSrcReg && (SrcReg == DstReg))) {
        TOut.emitRX(Mips::LUi, DstReg, Highest, IDLoc, STI);
        TOut.emitRX(Mips::LUi, ATReg, Hi, IDLoc, STI);
        TOut.emitRRX(Mips::DADDiu, DstReg, DstReg, Higher, IDLoc, STI);
        TOut.emitRRX(Mips::DADDiu, ATReg, ATReg, Lo, IDLoc, STI);
        ...
        TOut.emitRX(Mips::LUi, TmpReg, Highest, IDLoc, STI);
        TOut.emitRRX(Mips::DADDiu, TmpReg, TmpReg, Higher, IDLoc, STI);
        TOut.emitRRI(Mips::DSLL, TmpReg, TmpReg, 16, IDLoc, STI);
        TOut.emitRRX(Mips::DADDiu, TmpReg, TmpReg, Hi, IDLoc, STI);
        TOut.emitRRI(Mips::DSLL, TmpReg, TmpReg, 16, IDLoc, STI);
        if (!UseSrcReg)
          TOut.emitRRX(Mips::DADDiu, DstReg, TmpReg, Lo, IDLoc, STI);
        else {
          TOut.emitRRX(Mips::DADDiu, TmpReg, TmpReg, Lo, IDLoc, STI);
